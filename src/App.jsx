...
function App() {
  return (
    <div className="flex flex-col font-m1 justify-center items-center min-h-screen bg-slate-50">
      <div className="w-full lg:flex lg:flex-row">
        ...
        <div className="flex flex-col lg:w-1/2">
          ...
          <div className='hidden lg:block mt-8'>Webnya masih tahap BETA, Jadi Jangan Baper dulu🤞</div>
        </div>
      </div>
    </div>
  )
